...
namespace Shadowdactyl\Tests\Integration\Api\Client\Server\Allocation;
...
class CreateNewAllocationTest extends ClientApiIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('shadowdactyl.client_features.allocations.range_end', 5050);
    }
    ...
    {
        /** @var \Shadowdactyl\Models\Server $server */
