...
namespace Shadowdactyl\Tests\Integration\Services\Servers;
...
use Shadowdactyl\Models\Objects\DeploymentObject;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->bungeecord = Egg::query()
            ->where('author', 'support@shadowdactyl.io')
    ...
    public function testServerIsCreatedWithDeploymentObject()
    {
        ...
        /** @var \Shadowdactyl\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
