...
namespace Shadowdactyl\Tests\Integration\Services\Databases;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('shadowdactyl.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('shadowdactyl.client_features.databases.allow_random', false);
