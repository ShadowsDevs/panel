...
namespace Shadowdactyl\Tests\Integration\Services\Allocations;

use Shadowdactyl\Models\Allocation;
use Shadowdactyl\Tests\Integration\IntegrationTestCase;
use Shadowdactyl\Services\Allocations\FindAssignableAllocationService;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('shadowdactyl.client_features.allocations.enabled', true);
        config()->set('shadowdactyl.client_features.allocations.range_start', 0);
        config()->set('shadowdactyl.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('shadowdactyl.client_features.allocations.range_start', 5000);
        config()->set('shadowdactyl.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('shadowdactyl.client_features.allocations.range_start', 5000);
        config()->set('shadowdactyl.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('shadowdactyl.client_features.allocations.range_start', 'hodor');
        config()->set('shadowdactyl.client_features.allocations.range_end', 10);
        ...
        config()->set('shadowdactyl.client_features.allocations.range_start', 10);
        config()->set('shadowdactyl.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('shadowdactyl.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
