# Local Development
Shadowdactyl is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Shadowdactyl will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Shadowdactyl assets building. After that, its as
...
the asset URLs used in Shadowdactyl.

#### Development Environment
If you're using the [`shadowdactyl/development`](https://github.com/shadowdactyl/development) environments, which are
