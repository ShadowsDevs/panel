...
Shadowdactyl® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security
in mind, Shadowdactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive
UI to end users.

Stop settling for less. Make game servers a first class citizen on your platform.

![Image](https://cdn.shadowdactyl.io/site-assets/shadowdactyl_v1_demo.gif)
...
I would like to extend my sincere thanks to the following sponsors for helping fund Shadowdactyl's development.
[Interested in becoming a sponsor?](https://github.com/sponsors/shadowdactyl)
...
Shadowdactyl supports a wide variety of games by utilizing Docker containers to isolate each instance. This gives
...
Shadowdactyl® Copyright © 2015 - 2022 Dane Everitt and contributors.
