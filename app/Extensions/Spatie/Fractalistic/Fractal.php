...
namespace Shadowdactyl\Extensions\Spatie\Fractalistic;
...
use Shadowdactyl\Extensions\League\Fractal\Serializers\ShadowdactylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new ShadowdactylSerializer();
        }
