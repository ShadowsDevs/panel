...
namespace Shadowdactyl\Transformers\Api\Client;
...
use Shadowdactyl\Services\Servers\StartupCommandService;
...
class ServerTransformer extends BaseClientTransformer
{
    ...
    public function transform(Server $server): array
    {
        ...
        return [
            ...
            'identifier' => config('shadowdactyl.features.new_server_identifiers')
                ? $server->identifier
                : $server->uuidShort,
            '__deprecated_uuid_short' => $server->uuidShort,
            // In Shadowdactyl 2.0 we'll be replacing `identifier` above with the actual
     ...
     *
     * @throws \Shadowdactyl\Exceptions\Transformer\InvalidTransformerLevelException
     */
