...
use Shadowdactyl\Exceptions\Service\Node\ConfigurationNotPersistedException;
    ...
    public function handle(Node $node, array $data, bool $resetToken = false): Node
    {
        ...
        [$updated, $exception] = $this->connection->transaction(function () use ($data, $node) {
            ...
            try {
                ...
                //
                // @see https://github.com/ShadowsDevs/panel/issues/1931
                ...
                //
                // @see https://github.com/ShadowsDevs/panel/issues/2712
                return [$updated, true];
            }
