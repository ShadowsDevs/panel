...
use Shadowdactyl\Repositories\Eloquent\RecoveryTokenRepository;
use Shadowdactyl\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid;
...
class ToggleTwoFactorService
{
    ...
    public function handle(User $user, string $token, ?bool $toggleState = null): array
    {
        ...
        $isValidToken = $this->google2FA->verifyKey($secret, $token, config()->get('shadowdactyl.auth.2fa.window'));
