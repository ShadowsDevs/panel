...
namespace Shadowdactyl\Console\Commands\Environment;

use Illuminate\Console\Command;
use Illuminate\Contracts\Console\Kernel;
use Shadowdactyl\Traits\Commands\EnvironmentWriterTrait;
...
class AppSettingsCommand extends Command
{
     ...
     *
     * @throws \Shadowdactyl\Exceptions\ShadowdactylException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('shadowdactyl.service.author', 'unknown@unknown.com')
        );
        ...
        $this->output->comment('Please reference https://shadowdactyl.io/panel/1.0/additional_configuration.html#telemetry for more detailed information regarding telemetry data and collection.');
        $this->variables['SHADOWDACTYL_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            'Enable sending anonymous telemetry data?',
            config('shadowdactyl.telemetry.enabled', true)
        ) ? 'true' : 'false';
