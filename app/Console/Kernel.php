...
namespace Shadowdactyl\Console;

use Ramsey\Uuid\Uuid;
use Shadowdactyl\Models\ActivityLog;
use Illuminate\Console\Scheduling\Schedule;
use Illuminate\Database\Console\PruneCommand;
use Shadowdactyl\Repositories\Eloquent\SettingsRepository;
use Illuminate\Foundation\Console\Kernel as ConsoleKernel;
use Shadowdactyl\Services\Telemetry\TelemetryCollectionService;
use Shadowdactyl\Console\Commands\Schedule\ProcessRunnableCommand;
use Shadowdactyl\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use Shadowdactyl\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('shadowdactyl.telemetry.enabled')) {
