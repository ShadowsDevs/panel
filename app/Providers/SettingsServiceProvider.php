...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'shadowdactyl:guzzle:timeout',
        'shadowdactyl:guzzle:connect_timeout',
        'shadowdactyl:console:count',
        'shadowdactyl:console:frequency',
        'shadowdactyl:auth:2fa_required',
        'shadowdactyl:client_features:allocations:enabled',
