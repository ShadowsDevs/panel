...
use Shadowdactyl\Services\Eggs\EggConfigurationService;
use Shadowdactyl\Exceptions\Http\HttpForbiddenException;
use Shadowdactyl\Repositories\Eloquent\ServerRepository;
use Shadowdactyl\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \Shadowdactyl\Models\ActivityLog|null $activity */
