...
use Shadowdactyl\Models\Schedule;
use Illuminate\Http\JsonResponse;
use Shadowdactyl\Facades\Activity;
use Shadowdactyl\Helpers\Utilities;
use Shadowdactyl\Exceptions\DisplayException;
use Shadowdactyl\Repositories\Eloquent\ScheduleRepository;
use Shadowdactyl\Services\Schedules\ProcessScheduleService;
use Shadowdactyl\Transformers\Api\Client\ScheduleTransformer;
use Shadowdactyl\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/ShadowsDevs/panel/issues/2425
