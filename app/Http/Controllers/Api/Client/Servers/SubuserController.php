...
use Shadowdactyl\Services\Subusers\SubuserCreationService;
use Shadowdactyl\Transformers\Api\Client\SubuserTransformer;
use Shadowdactyl\Repositories\Wings\DaemonRevocationRepository;
use Shadowdactyl\Http\Controllers\Api\Client\ClientApiController;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Shadowdactyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Shadowdactyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Shadowdactyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Shadowdactyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
