 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Shadowdactyl\Models\Task> $tasks
 */
class Schedule extends Model
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Task, $this>
     */
