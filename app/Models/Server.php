...
namespace Shadowdactyl\Models;

use Illuminate\Notifications\Notifiable;
use Illuminate\Database\Query\JoinClause;
use Znck\Eloquent\Traits\BelongsToThrough;
use Shadowdactyl\Contracts\Models\Identifiable;
use Illuminate\Database\Eloquent\Relations\HasOne;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Shadowdactyl\Models\Traits\HasRealtimeIdentifier;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use Illuminate\Database\Eloquent\Relations\HasManyThrough;
use Shadowdactyl\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \Shadowdactyl\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Database[] $databases
 * @property int|null $databases_count
 * @property Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property Nest $nest
 * @property Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property ServerTransfer|null $transfer
 * @property User $user
 * @property \Illuminate\Database\Eloquent\Collection|\Shadowdactyl\Models\EggVariable[] $variables
...
class Server extends Model implements Identifiable
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Shadowdactyl\Models\User, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Subuser, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Shadowdactyl\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Shadowdactyl\Models\Nest, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Shadowdactyl\Models\Egg, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\EggVariable, $this>
     */
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/ShadowsDevs/panel/issues/2250
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Shadowdactyl\Models\Node, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Schedule, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Database, $this>
     */
     ...
     *
     * @return \Znck\Eloquent\Relations\BelongsToThrough<\Shadowdactyl\Models\Location, \Shadowdactyl\Models\Node>
     *
     * @throws \Exception
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Shadowdactyl\Models\ServerTransfer, $this>
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Shadowdactyl\Models\Backup, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasManyThrough<\Shadowdactyl\Models\Mount, \Shadowdactyl\Models\MountServer, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\MorphToMany<\Shadowdactyl\Models\ActivityLog, $this>
     */
