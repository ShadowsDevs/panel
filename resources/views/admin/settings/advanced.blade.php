...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Shadowdactyl.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="shadowdactyl:guzzle:connect_timeout" value="{{ old('shadowdactyl:guzzle:connect_timeout', config('shadowdactyl.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="shadowdactyl:guzzle:timeout" value="{{ old('shadowdactyl:guzzle:timeout', config('shadowdactyl.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="shadowdactyl:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('shadowdactyl:client_features:allocations:enabled', config('shadowdactyl.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="shadowdactyl:client_features:allocations:range_start" value="{{ old('shadowdactyl:client_features:allocations:range_start', config('shadowdactyl.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="shadowdactyl:client_features:allocations:range_end" value="{{ old('shadowdactyl:client_features:allocations:range_end', config('shadowdactyl.client_features.allocations.range_end')) }}">
