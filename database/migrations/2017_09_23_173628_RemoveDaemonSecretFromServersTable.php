...
use Shadowdactyl\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up(): void
    {
        ...
        $servers->each(function ($server) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('shadowdactyl.api.key_expire_time', 720))->toDateTimeString(),
