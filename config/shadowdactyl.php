...
return [
    ...
    */
    ...
    | standard Shadowdactyl shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.shadowdactyl.io/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('SHADOWDACTYL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('SHADOWDACTYL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('SHADOWDACTYL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('SHADOWDACTYL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('SHADOWDACTYL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('SHADOWDACTYL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('SHADOWDACTYL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('SHADOWDACTYL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('SHADOWDACTYL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('SHADOWDACTYL_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by Shadowdactyl.
    */

    'telemetry' => [
        'enabled' => env('SHADOWDACTYL_TELEMETRY_ENABLED', true),
    ],

    'features' => [
        'new_server_identifiers' => (bool) env('SHADOWDACTYL_USE_SERVER_IDENTIFIERS', false),
    ],
];
