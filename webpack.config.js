...
module.exports = {
    ...
    devServer: {
        ...
        server: {
            ...
            options: process.env.USE_LOCAL_CERTS
                ? {
                      ...
                      cert: path.join(__dirname, '../../docker/certificates/shadowdactyl.test.pem'),
                      key: path.join(__dirname, '../../docker/certificates/shadowdactyl.test-key.pem'),
                  }
                : undefined,
        },
        static: {
        ...
        allowedHosts: ['.shadowdactyl.test'],
        headers: {
